...
import { videoSettingSchema } from "../schemas/index.mjs";
import { isValid } from "@nily/utils";
import { SETTINGS_SCHEMAS } from "./schemas.mjs";
import { nodes_array_map } from "../constants.mjs";

export function Video(element, parentSettingSchema) {
    ...
    //const { name } = getSettingSchemaName('video', parentSettingSchema)
    ...
    //       name = undefined
    //   }
    const settingSchema = videoSettingSchema({
        name,
